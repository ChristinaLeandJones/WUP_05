...
This are the results for all the Female in our 
...
This table shows that 59% women who contracted Aids got the vaccine. 41% did not get the vaccine. 
...
Three test were ran and the results were that all the P value were so low to reject the NULL hypothesis. 
